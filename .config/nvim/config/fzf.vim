...
let $FZF_DEFAULT_OPTS='--no-mouse --bind=tab:down,btab:up --pointer ▶ --color=prompt:195,pointer:#5ADECD,hl+:#5ADECD,hl:#C574DD,info:#152238,bg+:#152238,fg+:#FFFFFF,gutter:-1'
