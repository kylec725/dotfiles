import { RenameProvider } from 'coc.nvim';
...
export default class TypeScriptRenameProvider implements RenameProvider {
    ...
    execRename(document: TextDocument, position: Position, token: CancellationToken): Promise<ServerResponse.Response<Proto.RenameResponse> | undefined>;
