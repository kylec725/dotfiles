export default class API {
    ...
    private static fromSimpleString;
    static readonly defaultVersion: API;
    static readonly v203: API;
    static readonly v206: API;
    static readonly v208: API;
    static readonly v213: API;
    static readonly v220: API;
    static readonly v222: API;
    static readonly v230: API;
    static readonly v234: API;
