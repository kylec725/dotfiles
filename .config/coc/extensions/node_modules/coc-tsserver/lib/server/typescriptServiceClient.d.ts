...
import { Uri, ServiceStat } from 'coc.nvim';
...
export default class TypeScriptServiceClient implements ITypeScriptServiceClient {
    ...
    execute(command: string, args: any, token: CancellationToken, lowPriority?: boolean): Promise<ServerResponse.Response<Proto.Response>>;
    executeAsync(command: string, args: Proto.GeterrRequestArgs, token: CancellationToken): Promise<ServerResponse.Response<Proto.Response>>;
    ...
    configurePlugin(pluginName: string, configuration: {}): any;
