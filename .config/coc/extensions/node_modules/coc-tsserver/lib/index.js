...
const plugins_1 = __webpack_require__(99);
...
const typingsStatus_1 = __importStar(__webpack_require__(97));
...
class TypeScriptSignatureHelpProvider {
    ...
    provideSignatureHelp(document, position, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const args = typeConverters.Position.toFileLocationRequestArgs(filepath, position);
            const response = yield this.client.interruptGetErr(() => this.client.execute('signatureHelp', args, token));
            if (response.type !== 'response' || !response.body) {
                return undefined;
            }
...
const versionStatus_1 = __importDefault(__webpack_require__(89));
const wireProtocol_1 = __webpack_require__(90);
const callbackMap_1 = __webpack_require__(91);
const requestQueue_1 = __webpack_require__(92);
const bufferSyncSupport_1 = __importDefault(__webpack_require__(93));
const diagnostics_1 = __webpack_require__(95);
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const resourceMap_1 = __webpack_require__(96);
class DiagnosticSet {
    constructor() {
