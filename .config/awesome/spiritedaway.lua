...
spiritedaway.initialize = function()
   -- Set Wallpaper
   gears.wallpaper.maximized(gears.filesystem.get_configuration_dir() .. "/wallpaper/spiritedaway.png")

   -- Import components
   require("components.exit-screen")
   require("components.volume-adjust")
   require("components.spiritedaway.titlebar")

   -- Import panels
   -- local left_panel = require("components.spiritedaway.left-panel")
   local top_panel = require("components.spiritedaway.top-panel")

   local icon_dir = gears.filesystem.get_configuration_dir() .. "/icons/tags/spiritedaway/"
